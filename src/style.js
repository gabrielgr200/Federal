const styles = {
  ...
  button: "h-8 rounded-sm border-0 cursor-pointer bg-[#0fdbff] text-lg transition-all duration-800 font-poppins font-semibold xs:text-[28px]text-black hover:bg-[#0fe3ff] hover:scale-105"
};
